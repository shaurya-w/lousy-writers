...
const Intro = () => { 
  return (
    <div className="bg-yellow-200 mt-[20vh] sm:mt-[25vh] w-[85vw] h-auto rounded-2xl flex flex-col sm:flex-row justify-between items-center p-6 space-y-5 sm:space-y-0 sm:space-x-5 sm:min-h-[50vh]">
