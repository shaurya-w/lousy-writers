...
function Blogcard({ blog }) {
  ...
  return (
    <div className="flex flex-col justify-evenly space-y-2.5 bg-ogyellow h-[190px] w-full rounded-2xl shadow-lg p-6 text-black transition-transform duration-300 hover:scale-105 hover:shadow-lg">
