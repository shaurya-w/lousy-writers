export const blogs = [
   {
  id: 9101,
  slug: "how-are-passwords-stored-on-the-internet",
...
A commonly used hashing algorithm for passwords is bcrypt. In Node.js projects, developers often install it using:
npm install bcrypt
...
But what if two or more people have the same password, like password123?
